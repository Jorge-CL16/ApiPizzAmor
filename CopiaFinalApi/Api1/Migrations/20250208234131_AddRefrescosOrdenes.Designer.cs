...
namespace Api1.Migrations
{
    ...
    [Migration("20250208234131_AddRefrescosOrdenes")]
    partial class AddRefrescosOrdenes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api1.Models.Refresco", b =>
                {
                    b.Property<int>("IdRefresco")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("idRefresco");
                    ...
                    b.HasKey("IdRefresco")
                        .HasName("PK__Refresco__B25E6C8BBD60C3A4");

                    b.ToTable("Refrescos");
                });

            modelBuilder.Entity("Api1.Models.RefrescosOrdene", b =>
                {
                    b.Property<int>("IdOrden")
                        .HasColumnType("int")
                        .HasColumnName("idOrden");
                    ...
                    b.HasKey("IdOrden", "IdRefresco")
                        .HasName("PK__RefrescosOrdene");

                    b.HasIndex("IdRefresco");

                    b.ToTable("RefrescosOrdenes");
                });
            ...
            modelBuilder.Entity("Api1.Models.RefrescosOrdene", b =>
                {
                    b.HasOne("Api1.Models.Ordene", "Ordene")
                        .WithMany("RefrescosOrdenes")
                        .HasForeignKey("IdOrden")
                        .IsRequired()
                        .HasConstraintName("FK_RefrescosOrdene_Ordenes");

                    b.HasOne("Api1.Models.Refresco", "Refresco")
                        .WithMany("RefrescosOrdenes")
                        .HasForeignKey("IdRefresco")
                        .IsRequired()
                        .HasConstraintName("FK_RefrescosOrdene_Refrescos");

                    b.Navigation("Ordene");

                    b.Navigation("Refresco");
                });
